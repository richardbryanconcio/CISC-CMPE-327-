...
class FrontEndHomePageTest(BaseCase):
    def test_register_success(self, *_):
        ...
        def test_register_Success_R1_3(self, *_):
            ...
            self.type("#email", "testr1133@test.com")
            self.type("#name", "userR1133")
            self.type("#password", "Password1!")
            self.type("#password2", "Password1!")
   
            # click enter button
            self.click('input[type="submit"]')
            # check user is now on login page
        ...
        test_register_Success_R1_3(self)
        test_register_success_R1_4_5(self)
        test_register_success_R1_5_5(self)
    ...
    def test_register_fail(self, *_):
        ...
        def test_register_fail_partition_4(self, *_):
            """
            This is a sample front end integration testtest using
            input partitoning testing to show user registration fail
        ...
        def test_register_fail_partition_6(self, *_):
            """
            This is a sample front end integration test using input
            partitoning testing to show user registration Fail. With
            invalid email and password2 not matching password.
            """
            # open register page
            self.open(base_url + '/register')
            # fill email, name, password and password2
        ...
        def test_register_fail_partition_7(self, *_):
            """
            This is a sample front end integration test using input
            partitioning testing to show user registration Fail. With
        ...
        def test_register_fail_partition_8(self, *_):
            ...
            This is a sample front end integration test  using input
            partitioning testing to show user registration Fail. With
            invalid email, password, and password 2 not matching password.
            """
            # open register page
            self.open(base_url + '/register')
            # fill email, name, password and password2
        ...
        def test_register_fail_partition_10(self, *_):
            ...
            This is a sample front end integration test  using input
            partitioning testing to show user registration Fail with
            invalid email, username, and password2 not matching
            password.
            """
            # open register page
            self.open(base_url + '/register')
        ...
        def test_register_fail_partition_11(self, *_):
            """
            This is a sample front end integration test using
            input partitioning testing to show user registration
            Fail with invalid email, username,and password
            while password2 matches password.
            """
            # open register page
            self.open(base_url + '/register')
            # fill email, name, password and password2
        ...
        def test_register_fail_partition_12(self, *_):
            ...
            This is a sample front end integration test  using input
            partitioning testing to show user registration Fail with
            invalid email, username, password, and password2.
            """
            # open register page
            self.open(base_url + '/register')
            # fill email, name, password and password2
        ...
        test_register_fail_R1_1_1(self)
        test_register_fail_R1_1_2(self)
        test_register_fail_R1_3(self)
        test_register_success_R1_6_3(self)
        test_register_fail_R1_7(self)
        test_register_fail_R1_1_3(self)
        test_register_fail_R1_4_1(self)
        test_register_fail_R1_4_2(self)
        test_register_fail_R1_4_3(self)
        test_register_fail_R1_4_4(self)
        test_register_fail_R1_5_1(self)
        test_register_fail_R1_5_2(self)
        test_register_fail_R1_5_3(self)
        test_register_fail_R1_5_4(self)
        test_register_fail_R1_6_1(self)
        test_register_fail_R1_6_2(self)
        test_register_fail_partition_1(self)
        test_register_fail_partition_2(self)
        test_register_fail_partition_3(self)
        test_register_fail_partition_4(self)
        test_register_fail_partition_5(self)
        test_register_fail_partition_6(self)
        test_register_fail_partition_7(self)
        test_register_fail_partition_8(self)
        test_register_fail_partition_9(self)
        test_register_fail_partition_10(self)
        test_register_fail_partition_11(self)
        test_register_fail_partition_12(self)
    ...
    def test_register_human_shotgun_success(self, *_):
        ...
        def test_register_shotgun_16(self, *_):
            """
            This is a sample black box shotgun test case.
            Here, name has upper, lowecase and numebers;
        ...
        def test_register_shotgun_22(self, *_):
            ...
            self.open(base_url + '/register')
            # fill email, name, password and password2
            self.type("#email", "test2341433431431434312341234shot21@test.com")
        ...
        test_register_shotgun_1(self)
        test_register_shotgun_6(self)
        test_register_shotgun_10(self)
        test_register_shotgun_16(self)
        test_register_shotgun_17(self)
        test_register_shotgun_18(self)
        test_register_shotgun_19(self)
        test_register_shotgun_22(self)
        test_register_shotgun_23(self)
 
    def test_register_human_shotgun_fail(self, *_):
        ...
        def test_register_shotgun_3(self, *_):
            ...
            Here, input is long email,
            but password2 does not match with password.
            """
            # open register page
            self.open(base_url + '/register')
            # fill email, name, password and password2
            self.type("#email", "testshotreallyreallylongstrqueness3@test.com")
        ...
        def test_register_shotgun_21(self, *_):
            ...
            self.type("#password", "SpellSpellSpellSpellSpellSpellSpell#123")
            self.type("#password2", "SpellSpellSpellSpellSpellSpellSpell#123")
        ...
        test_register_shotgun_2(self)
        test_register_shotgun_3(self)
        test_register_shotgun_4(self)
        test_register_shotgun_5(self)
        test_register_shotgun_7(self)
        test_register_shotgun_8(self)
        test_register_shotgun_9(self)
        test_register_shotgun_11(self)
        test_register_shotgun_12(self)
        test_register_shotgun_13(self)
        test_register_shotgun_14(self)
        test_register_shotgun_15(self)
        test_register_shotgun_20(self)
        test_register_shotgun_21(self)
        test_register_shotgun_24(self)
        test_register_shotgun_25(self)
